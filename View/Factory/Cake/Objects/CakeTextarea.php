...
/**
 * Creates an object representing a CakePHP textarea element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeTextarea extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-textarea';
