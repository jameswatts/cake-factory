...
/**
 * Creates an object representing a CakePHP secure element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeSecure extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-secure';
