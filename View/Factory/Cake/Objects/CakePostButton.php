...
/**
 * Creates an object representing a CakePHP post button element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakePostButton extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-post-button';
