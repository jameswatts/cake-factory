...
/**
 * Creates an object representing a CakePHP checkbox element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeCheckbox extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-checkbox';
