...
/**
 * Creates an object representing a CakePHP inputs element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeInputs extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-inputs';
