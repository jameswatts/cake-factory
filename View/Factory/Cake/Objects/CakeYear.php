...
/**
 * Creates an object representing a CakePHP year element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeYear extends CakeElement {
