...
/**
 * Creates an object representing a CakePHP post link element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakePostLink extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-post-link';
