...
/**
 * Creates an object representing a CakePHP submit element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeSubmit extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-submit';
