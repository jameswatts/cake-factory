...
/**
 * Creates an object representing a CakePHP meridian element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeMeridian extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-meridian';
