...
/**
 * Creates an object representing a CakePHP crumbs element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeCrumbs extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-crumbs';
