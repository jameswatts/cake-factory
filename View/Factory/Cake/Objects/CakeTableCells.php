...
/**
 * Creates an object representing a CakePHP table cells element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeTableCells extends CakeElement {
 ...
 */
	protected $_template = 'table-cells';
 ...
 */
	protected $_nodeType = 'cake-table-cells';
