...
/**
 * Creates an object representing a CakePHP date time element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeDateTime extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-date-time';
