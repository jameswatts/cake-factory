...
/**
 * Creates an object representing a CakePHP minute element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeMinute extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-minute';
