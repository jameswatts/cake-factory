...
/**
 * Creates an object representing a CakePHP month element.
 *
 * @package       CakeFactory.View.Factory.Cake.Objects
 */
class CakeMonth extends CakeElement {
 ...
 */
	protected $_nodeType = 'cake-month';
